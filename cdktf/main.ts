...
const app = new App();
new LambdaStack(app, 'lambda-sign-in', {
  path: "../lambda-sign-in/dist",
  handler: "index.handler",
  runtime: "nodejs14.x",
  stageName: "auth-sign-in",
  version: "v0.0.2"
});

new LambdaStack(app, 'lambda-sign-up', {
  path: "../lambda-sign-up/dist",
  handler: "index.handler",
  runtime: "nodejs14.x",
  stageName: "auth-sign-up",
  version: "v0.0.1"
});
